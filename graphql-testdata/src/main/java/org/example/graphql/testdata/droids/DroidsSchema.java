...
public class DroidsSchema implements SchemaDefinition {
    ...
    static final GraphQLEnumType episodeEnum = GraphQLEnumType.newEnum()
            .name("Episode")
    ...
    static final GraphQLInterfaceType characterInterface = GraphQLInterfaceType.newInterface()
            .name("Character")
    ...
    static final GraphQLObjectType queryType = GraphQLObjectType.newObject()
            .name("DroidQueries")
            .field(GraphQLFieldDefinition.newFieldDefinition()
                    .name("droidHero")
                    .type(droidType)
